  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Get in touch with Shree Durga Saraswati Janata Secondary School. Contact us for admissions, inquiries, or to schedule a campus visit." 
        />
      </Helmet>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-10">
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                >
                  ...
                  <Button variant="hero" size="sm" asChild>
                    <a href="https://wa.me/977XXXXXXXXXX" target="_blank" rel="noopener noreferrer">
                      WhatsApp Us
                    </a>
                  </Button>
                </motion.div>
              ...
              {/* Contact Form */}
              <motion.div
                className="lg:col-span-2 bg-card p-8 rounded-2xl shadow-card border border-border/50"
                initial={{ opacity: 0, x: 30 }}
                animate={{ opacity: 1, x: 0 }}
