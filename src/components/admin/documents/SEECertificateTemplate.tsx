...
const SEECertificateTemplate = forwardRef<HTMLDivElement, SEECertificateTemplateProps>(
  ({ student, schoolSettings, data }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="bg-white w-[800px] min-h-[1000px] mx-auto shadow-lg relative"
        style={{
      ...
      >
        ...
        <div className="p-10 pt-8">
          ...
          <div className="text-center mb-6">
            <div className="flex justify-center items-center gap-8 mb-4">
              ...
              <div className="text-center flex-1">
                <p className="text-base font-semibold" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>नेपाल सरकार</p>
                <p className="font-bold text-xl tracking-wider">GOVERNMENT OF NEPAL</p>
                <p className="text-base font-semibold text-red-700" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>राष्ट्रिय परीक्षा बोर्ड</p>
                <p className="font-bold text-xl text-red-700 tracking-wider">NATIONAL EXAMINATIONS BOARD</p>
                <div className="mt-2">
                  <p className="text-sm font-semibold" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>माध्यमिक शिक्षा परीक्षा, कक्षा-१०</p>
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-red-800 mb-1" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>
              प्रमाण-पत्र
            </h2>
            <h1 className="text-4xl font-bold tracking-wider text-blue-900" style={{ fontFamily: "'Times New Roman', serif" }}>
              Certificate
            </h1>
          </div>

          {/* Certificate Content */}
          <div className="space-y-5 text-base leading-relaxed px-6">
            <p className="italic">
            ...
            <p className="italic">
              of
              <span className="border-b-2 border-dotted border-black font-bold uppercase mx-2 pb-1 inline-block min-w-[350px]">
