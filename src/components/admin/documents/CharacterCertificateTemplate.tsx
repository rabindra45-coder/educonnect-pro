...
const CharacterCertificateTemplate = forwardRef<HTMLDivElement, CharacterCertificateTemplateProps>(
  ({ student, schoolSettings, data }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="bg-white w-[800px] min-h-[1050px] mx-auto shadow-lg relative"
        style={{
      ...
      >
        ...
        <div className="absolute left-4 top-20 bottom-20 w-2 bg-gradient-to-b from-red-700 via-red-600 to-red-700 rounded-full flex flex-col justify-around items-center py-4">
          {Array.from({ length: 15 }).map((_, i) => (
            <div key={i} className="w-4 h-4 bg-red-700 rounded-full" />
          ))}
        </div>
        ...
        <div className="p-8 pl-12">
          ...
          <div className="text-center mb-4">
            <h1 className="text-2xl font-bold text-red-800 italic" style={{ fontFamily: "'Georgia', serif" }}>
          ...
          <div className="flex justify-between items-start mb-4 px-4">
            <div className="w-24 h-24 border-2 border-red-700 flex items-center justify-center bg-white shadow-md">
              {schoolSettings.logo_url ? (
                <img src={schoolSettings.logo_url} alt="School Logo" className="w-full h-full object-contain p-1" />
              ) : (
          ...
          <div className="text-center my-6">
            <div className="inline-block bg-gradient-to-r from-red-800 via-red-700 to-red-800 text-white px-8 py-3 text-xl font-bold tracking-widest shadow-lg transform rotate-0"
          ...
          {/* Certificate Content */}
          <div className="space-y-4 text-base leading-relaxed px-6" style={{ fontFamily: "'Times New Roman', serif" }}>
