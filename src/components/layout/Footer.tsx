        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src={schoolLogo} alt="Shree Durga Saraswati Janata Secondary School Logo" className="w-16 h-16 object-contain bg-white rounded-full p-1" />
              <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-secondary hover:text-secondary-foreground transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map(link => <li key={link.name}>
                  <Link to={link.path} className="text-primary-foreground/80 hover:text-secondary transition-colors text-sm flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {academics.map(link => <li key={link.name}>
                  <Link to={link.path} className="text-primary-foreground/80 hover:text-secondary transition-colors text-sm flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-secondary"></span>
                    {link.name}
                  </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a className="text-primary-foreground/80 hover:text-secondary transition-colors text-sm" href="tel:+977-9746834671">
                  +977-9746834671
                </a>
              </li>
              <li className="flex items-center gap-3">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <button onClick={scrollToTop} className="flex items-center gap-2 text-primary-foreground/60 hover:text-secondary transition-colors text-sm">
