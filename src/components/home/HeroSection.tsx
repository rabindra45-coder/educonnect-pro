...
const notices = [
  "Admission Open for Academic Year 2081/82 - Apply Now!",
  "Annual Sports Week starts from Poush 15 - All students must participate",
  "Parent-Teacher Meeting scheduled for Poush 20, 2081",
  "Winter vacation from Magh 1 to Magh 15, 2081",
];
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Shree Durga Saraswati Janata Secondary School Campus"
          ...
          <div className="overflow-hidden flex-1">
            <div className="animate-marquee flex whitespace-nowrap">
              {[...notices, ...notices].map((notice, index) => (
                <span
                  key={index}
                  className="mx-8 text-secondary-foreground text-sm font-medium"
                >
                  {notice}
      ...
      <div className="container mx-auto px-4 relative z-10 pt-16">
        <div className="max-w-3xl">
          ...
          >
            <span className="inline-block px-4 py-2 rounded-full bg-secondary/20 text-secondary text-sm font-medium mb-6 backdrop-blur-sm border border-secondary/30">
              🎓 Excellence in Education Since 20XX
            </span>
          </motion.div>
