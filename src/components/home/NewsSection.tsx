...
const NewsSection = () => {
  ...
  useEffect(() => {
    supabase
      .from("notices")
      .select("id, title, content, category, created_at, hero_image_url")
          ...
          {loading ? (
            ...
            notices.map((notice, i) => (
              <motion.article
                ...
                whileHover={{
                  y: -6,
                  boxShadow: "0 20px 40px -15px hsla(220,65%,20%,0.15)",
                }}
              ...
              >
                ...
                <div className="relative h-48 sm:h-52 overflow-hidden">
                  {notice.hero_image_url ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-primary/8 to-secondary/8 flex items-center justify-center">
                      <motion.span
                  ...
                  <motion.div
                    ...
                    initial={{ width: "0%" }}
                    animate={{
                      width: hoveredId === notice.id ? "100%" : "0%",
                    }}
                    transition={{ duration: 0.5 }}
                  />
                </div>
                ...
                <div className="p-6">
                  ...
                  <Link
                    to="/notices"
                    className="inline-flex items-center gap-1.5 text-primary font-medium text-xs group/link"
                  >
                    Read More
